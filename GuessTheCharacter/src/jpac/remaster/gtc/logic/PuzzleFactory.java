...
public class PuzzleFactory {
	...
	public static Puzzle getPuzzleById(int id) {
		...
		// Version 2.0	
		case 100:
			return new Puzzle("VANDER:DECKEN", Category.CLOTHING, 113287, "000113", id, 2);
		case 101:
			return new Puzzle("VASCO:SHOT", Category.ACCESSORY, 434019, "004913", id, 3);
		case 102:
			return new Puzzle("JERRY", Category.ABILITY, 993653, "011921", id, 2);
		case 103:
			return new Puzzle("LIP:DOUGHTY", Category.FACE, 881059, "012520", id, 2);
		case 104:
			return new Puzzle("VERY:GOOD", Category.FACE, 846792, "013213", id, 2);
		case 105:
			return new Puzzle("NOJIKO", Category.ACCESSORY, 371332, "020720", id, 2);
		case 106:
			return new Puzzle("JESUS:BURGESS", Category.CLOTHING, 893706, "021421", id, 4);
		case 107:
			return new Puzzle("BORSA-:LINO", Category.BODY, 951779, "023313", id, 2);
		case 108:
			return new Puzzle("KAMAKIRI", Category.FACE, 939323, "025721", id, 2);
		case 109:
			return new Puzzle("ENEL", Category.ABILITY, 406108, "030420", id, 1);
		case 110:
			return new Puzzle("WANZE", Category.ACCESSORY, 614739, "031113", id, 1);
		case 111:
		...
		case 114:
			return new Puzzle("YASOPP", Category.CLOTHING, 563862, "042813", id, 3);
		case 115:
			return new Puzzle("NICO:OLVIA", Category.FACE, 298569, "045020", id, 1);
		case 116:
			return new Puzzle("KOKORO", Category.FACE, 848813, "045421", id, 1);
		case 117:
			return new Puzzle("BELLE-:MERE", Category.FACE, 273802, "050413", id, 1);
		case 118:
		...
		case 122:
			return new Puzzle("LAKI", Category.ACCESSORY, 324334, "071621", id, 2);
		case 123:
			return new Puzzle("CC", Category.WEAPON, 277555, "081913", id, 1);
		case 124:
			return new Puzzle("LABOON", Category.FACE, 490194, "083221", id, 1);
		case 125:
			return new Puzzle("MAKINO", Category.ACCESSORY, 202675, "091321", id, 2);
		case 126:
			return new Puzzle("DOUBLE-:FINGER", Category.FACE, 975352, "095321", id, 3);
		case 127:
			return new Puzzle("EDWARD:NEWGATE", Category.ABILITY, 898757, "101913", id, 1);
		case 128:
			return new Puzzle("VALEN-:TINE", Category.CLOTHING, 427796, "103921", id, 3);
		case 129:
		...
		case 133:
			return new Puzzle("CROCO-:DILE", Category.WEAPON, 862488, "130613", id, 1);
		case 134:
			return new Puzzle("PAULIE", Category.CLOTHING, 200317, "131620", id, 2);
		case 135:
			return new Puzzle("JIMBEI", Category.ABILITY, 946834, "135813", id, 1);
		case 136:
			return new Puzzle("BECKMAN", Category.CLOTHING, 628818, "142621", id, 3);
		case 137:
			return new Puzzle("HYOUZOU", Category.FACE, 432042, "145320", id, 1);
		case 138:
			return new Puzzle("FUJITORA", Category.FACE, 847895, "153421", id, 1);
		case 139:
			return new Puzzle("SHANKS", Category.MARKS, 454728, "155312", id, 1);
		case 140:
			return new Puzzle("BOA", Category.ABILITY, 881513, "155413", id, 1);
		case 141:
			return new Puzzle("CHINJAO", Category.MARKS, 553661, "161921", id, 1);
		case 142:
		...
		case 149:
			return new Puzzle("DALTON", Category.CLOTHING, 322581, "192612", id, 2);
		case 150:
			return new Puzzle("BUGGY", Category.FACE, 306901, "202312", id, 1);
		case 151:
			return new Puzzle("DECKEN", Category.WEAPON, 698723, "205013", id, 3);
		case 152:
			return new Puzzle("CALIFA", Category.ABILITY, 360756, "212412", id, 3);
		case 153:
			return new Puzzle("ARLONG", Category.FACE, 435019, "215220", id, 1);
		case 154:
			return new Puzzle("OTOHIME", Category.CLOTHING, 473753, "222112", id, 3);
		case 155:
			return new Puzzle("KURO", Category.WEAPON, 255022, "224713", id, 1);
		case 156:
			return new Puzzle("AVALO:PIZARRO", Category.CLOTHING, 578714, "224720", id, 3);
		case 157:
			return new Puzzle("VAN:AUGER", Category.ACCESSORY, 487516, "232013", id, 2);
		case 158:
			return new Puzzle("PEKOMS", Category.FACE, 254732, "232912", id, 1);
		case 159:
			return new Puzzle("BABY:FIVE", Category.ABILITY, 815645, "233220", id, 1);
		case 160:
			return new Puzzle("WAPOL", Category.ABILITY, 258098, "242520", id, 1);
		case 161:
			return new Puzzle("LAFITTE", Category.FACE, 752212, "243513", id, 2);
		case 162:
			return new Puzzle("PERONA", Category.CLOTHING, 139699, "244712", id, 1);
		case 163:
			return new Puzzle("ROUGE", Category.ACCESSORY, 687013, "253312", id, 1);
		case 164:
			return new Puzzle("BELLAMY", Category.MARKS, 883719, "262220", id, 1);
		case 165:
			return new Puzzle("RAYLEIGH", Category.ACCESSORY, 532890, "262712", id, 4);
		case 166:
			return new Puzzle("PEARL", Category.WEAPON, 236652, "263313", id, 3);
		case 167:
			return new Puzzle("REBECCA", Category.CLOTHING, 364373, "271712", id, 2);
		case 168:
			return new Puzzle("BLUENO", Category.BODY, 932807, "272720", id, 1);
		case 169:
			return new Puzzle("DON:KRIEG", Category.WEAPON, 603381, "274013", id, 1);
		case 170:
			return new Puzzle("GIN", Category.CLOTHING, 244830, "275513", id, 4);
		case 171:
			return new Puzzle("RYUMA", Category.CLOTHING, 650113, "281212", id, 3);
		case 172:
			return new Puzzle("BOA", Category.ACCESSORY, 213801, "283320", id, 1);
		case 173:
		...
		case 176:
			return new Puzzle("SCOPPER:GABAN", Category.FACE, 928529, "300112", id, 2);
		case 177:
			return new Puzzle("STRAW-:BERRY", Category.FACE, 224667, "302620", id, 2);
		case 178:
			return new Puzzle("SHALULIA", Category.FACE, 847104, "304512", id, 2);
		case 179:
			return new Puzzle("WIPER", Category.MARKS, 463523, "312612", id, 3);
		case 180:
			return new Puzzle("YAMAKIJI", Category.FACE, 941927, "312820", id, 2);
		case 181:
			return new Puzzle("KUREHA", Category.CLOTHING, 803629, "313619", id, 2);
		case 182:
			return new Puzzle("SHANKS", Category.ACCESSORY, 624465, "320712", id, 1);
		case 183:
			return new Puzzle("DOBERMAN", Category.FACE, 903706, "323720", id, 2);
		case 184:
			return new Puzzle("SHIKI", Category.CLOTHING, 665908, "324712", id, 2);
		case 185:
			return new Puzzle("SHIRA-:HOSHI", Category.BODY, 668281, "332412", id, 1);
		case 186:
			return new Puzzle("ONIGUMO", Category.ACCESSORY, 471120, "333720", id, 2);
		case 187:
		...
		case 191:
			return new Puzzle("CALGARA", Category.MARKS, 627040, "353520", id, 3);
		case 192:
			return new Puzzle("OIMO", Category.FACE, 481362, "354019", id, 1);
		case 193:
			return new Puzzle("SHYARLY", Category.BODY, 998692, "363212", id, 2);
		case 194:
			return new Puzzle("KEIMI", Category.CLOTHING, 580065, "363520", id, 2);
		case 195:
			return new Puzzle("SMOKER", Category.ACCESSORY, 942925, "372612", id, 2);
		case 196:
			return new Puzzle("CARUE", Category.FACE, 865343, "372920", id, 1);
		case 197:
			return new Puzzle("SENTO-:MARU", Category.CLOTHING, 326310, "375719", id, 3);
		case 198:
			return new Puzzle("SURUME", Category.FACE, 728212, "381312", id, 1);
		case 199:
			return new Puzzle("CHAKA", Category.CLOTHING, 655916, "382220", id, 4);
		case 200:
			return new Puzzle("BARON:TAMAGO", Category.FACE, 806823, "384712", id, 2);
		case 201:
			return new Puzzle("SANJUAN:WOLF", Category.FACE, 737584, "390619", id, 1);
		case 202:
			return new Puzzle("SARQUISS", Category.FACE, 156085, "391020", id, 3);
		case 203:
			return new Puzzle("T BONE", Category.CLOTHING, 253649, "394212", id, 2);
		case 204:
			return new Puzzle("BIG MOM", Category.FACE, 913566, "394420", id, 1);
		case 205:
			return new Puzzle("TILE-:STONE", Category.MARKS, 602131, "401712", id, 3);
		case 206:
			return new Puzzle("CHIMNEY", Category.CLOTHING, 509402, "402320", id, 4);
		case 207:
			return new Puzzle("BROOK", Category.ABILITY, 850298, "404619", id, 2);
		case 208:
			return new Puzzle("TOTO", Category.CLOTHING, 279346, "405412", id, 4);
		case 209:
			return new Puzzle("COBY", Category.CLOTHING, 214568, "411820", id, 1);
		case 210:
			return new Puzzle("GAN FALL", Category.WEAPON, 388706, "414412", id, 3);
		case 211:
			return new Puzzle("DARUMA", Category.FACE, 519594, "420819", id, 2);
		case 212:
			return new Puzzle("CONIS", Category.BODY, 333134, "421720", id, 2);
		case 213:
			return new Puzzle("HILULUK", Category.ACCESSORY, 735965, "423312", id, 2);
		case 214:
			return new Puzzle("DADAN", Category.FACE, 533962, "430820", id, 2);
		case 215:
			return new Puzzle("JIGORO", Category.CLOTHING, 228666, "433519", id, 4);
		case 216:
			return new Puzzle("DOC Q", Category.FACE, 211924, "435820", id, 2);
		case 217:
			return new Puzzle("CROCUS", Category.CLOTHING, 751646, "443919", id, 3);
		case 218:
			return new Puzzle("DOMINO", Category.FACE, 100078, "444220", id, 1);
		case 219:
			return new Puzzle("DORRY", Category.FACE, 316654, "454220", id, 1);
		case 220:
			return new Puzzle("KING:NEPTUNE", Category.FACE, 631304, "461919", id, 1);
		case 221:
		...
		case 226:
			return new Puzzle("FUKABO-:SHI", Category.FACE, 886733, "500820", id, 1);
		case 227:
			return new Puzzle("SALDEATH", Category.FACE, 891135, "501219", id, 2);
		case 228:
			return new Puzzle("BECKMAN", Category.FACE, 628695, "511019", id, 2);
		case 229:
			return new Puzzle("FUKURO", Category.FACE, 673140, "511920", id, 2);
		case 230:
			return new Puzzle("GENBO", Category.ACCESSORY, 344010, "521820", id, 3);
		case 231:
			return new Puzzle("BRAHAM", Category.WEAPON, 161906, "534120", id, 4);
		case 232:
			return new Puzzle("SPANDAM", Category.ACCESSORY, 937045, "540112", id, 2);
		case 233:
			return new Puzzle("HELMEPPO", Category.ACCESSORY, 743664, "544220", id, 2);
		case 234:
			return new Puzzle("HERACLES", Category.BODY, 987594, "551720", id, 3);
		case 235:
			return new Puzzle("GOMO-:RRAH", Category.BODY, 104033, "552112", id, 2);
		case 236:
			return new Puzzle("TONJIT", Category.FACE, 861262, "555519", id, 2);
		case 237:
			return new Puzzle("SODOM", Category.BODY, 119368, "555712", id, 2);
		case 238:
			return new Puzzle("HODY:JONES", Category.CLOTHING, 703148, "555920", id, 2);
		case 239:
			return new Puzzle("BARTO-:LOMEO", Category.MARKS, 146361, "565119", id, 2);
		case 240:
			return new Puzzle("ICEBURG", Category.CLOTHING, 959104, "565720", id, 2);
		case 241:
			return new Puzzle("AISA", Category.FACE, 935353, "565812", id, 2);
		case 242:
			return new Puzzle("IKAROS", Category.ACCESSORY, 812686, "573620", id, 2);
		case 243:
			return new Puzzle("CHARLOSS", Category.FACE, 608435, "574519", id, 1);
		case 244:
			return new Puzzle("KUMADORI", Category.BODY, 914280, "583612", id, 3);
		case 245:
			return new Puzzle("DUVAL", Category.FACE, 582019, "583920", id, 1);
		case 246:
			return new Puzzle("CATARINA", Category.FACE, 875554, "585919", id, 1);
		case 247:
			return new Puzzle("USOLAND", Category.FACE, 139824, "591812", id, 1);
		case 248:
			return new Puzzle("JEAN:BART", Category.MARKS, 955255, "592520", id, 3);
		case 249:
			return new Puzzle("RAYLEIGH", Category.FACE, 210032, "595519", id, 2);
